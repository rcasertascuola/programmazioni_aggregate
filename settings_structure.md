...
| **TabelleCorrelate** | **Obbligatoria per `LogicaModuli`**. Un elenco dei nomi dei template delle tabelle del blocco, separati da virgola e nell'ordine corretto. Il primo nome deve corrispondere a `NomeTabellaTemplate`. | `MODULO,Unità Didattiche,Abilità`                                           |
